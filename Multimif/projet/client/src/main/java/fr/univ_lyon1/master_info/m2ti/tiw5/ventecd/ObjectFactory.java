...
public class ObjectFactory {
    ...
    private final static QName _Genre_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/ventecd", "genre");
    private final static QName _Prix_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/ventecd", "prix");
    ...
    private final static QName _Maisondisque_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/ventecd", "maisondisque");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/ventecd", name = "genre")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/ventecd", name = "prix")
    public JAXBElement<Double> createPrix(Double value) {
        return new JAXBElement<Double>(_Prix_QNAME, Double.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/ventecd", name = "maisondisque")
    public JAXBElement<String> createMaisondisque(String value) {
        return new JAXBElement<String>(_Maisondisque_QNAME, String.class, null, value);
    }
