...
@WebServiceClient(name = "CAODataBase", 
                  ...
                  targetNamespace = "caodatabaseservice.services.sic") 
public class CAODataBase_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("caodatabaseservice.services.sic", "CAODataBase");
    public final static QName CAODataBaseSOAP = new QName("caodatabaseservice.services.sic", "CAODataBaseSOAP");
    static {
        URL url = null;
        try {
