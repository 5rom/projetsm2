 ...
 * generated in the fr.univ_lyon1.master_info.m2ti.tiw5.services_cao package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetProduitListResponse_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", "getProduitListResponse");
    private final static QName _AddProduitResponse_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", "addProduitResponse");
    private final static QName _GetCompositionListResponse_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", "getCompositionListResponse");
    private final static QName _DeleteProduitResponse_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", "deleteProduitResponse");
    private final static QName _DeleteCompositionResponse_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", "deleteCompositionResponse");
    private final static QName _UpdateProduitResponse_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", "updateProduitResponse");
    private final static QName _AddCompositionResponse_QNAME = new QName("http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", "addCompositionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fr.univ_lyon1.master_info.m2ti.tiw5.services_cao
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", name = "getProduitListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", name = "addProduitResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", name = "getCompositionListResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", name = "deleteProduitResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", name = "deleteCompositionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", name = "updateProduitResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://master-info.univ-lyon1.fr/M2TI/TIW5/services_cao", name = "addCompositionResponse")
