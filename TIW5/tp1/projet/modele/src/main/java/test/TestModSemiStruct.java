...
public class TestModSemiStruct extends TestCase {
	...
	// Méthode de test appellée automatiquement (car son nom commence par "test")
	public void test() throws JAXBException{
		try{
            ...
            // Instanciation des artistes de l'album et des pistes
	        ...
	        logger.info("Contenu XML VALIDE obtenu :");
